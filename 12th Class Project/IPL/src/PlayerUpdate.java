...
public class PlayerUpdate extends javax.swing.JFrame {
    ...
    String x,y;
public PlayerUpdate(String p,String q)
    {
    x=p;
    y=q;
    initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 340, -1, -1));
        ...
        jPanel1.add(jtfsrno, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 150, 150, 30));
        ...
        jPanel1.add(jtfname, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 150, 150, 30));
        ...
        jPanel1.add(jtfage, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 190, 150, 30));

        jLabel9.setFont(new java.awt.Font("Lucida Calligraphy", 1, 18));
        jLabel9.setText("Sex");
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 190, -1, -1));

        jtfsex.setFont(new java.awt.Font("Lucida Calligraphy", 1, 18));
        jPanel1.add(jtfsex, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 190, 150, 30));
        ...
        jPanel1.add(jtfaddress, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 230, 150, 30));
        ...
        jPanel1.add(jtfphone, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 230, 150, 30));
        ...
        jPanel1.add(jtfcategory, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 270, 150, 30));

        jLabel13.setFont(new java.awt.Font("Lucida Calligraphy", 1, 18));
        jLabel13.setText("Team");
        jPanel1.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 270, -1, -1));

        jtfteam.setFont(new java.awt.Font("Lucida Calligraphy", 1, 18));
        jPanel1.add(jtfteam, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 270, 150, 30));
       ...
       try
        {
            ...
            String srno,age,phone,name,sex,address,category,team;
              ...
              String querry;
              querry="update player set srno="+"'"+srno+"'"+","+"name="+"'"+name+"'"+","+"age="+"'"+age+"'"+","+"sex="+"'"+sex+"'"+","+"address="+"'"+address+"'"+","+"phone="+"'"+phone+"'"+","+"category="+"'"+category+"'"+","+"team="+"'"+team+"'"+" where srno="+"'"+search+"'"+" or name="+"'"+search+"'"+" or address="+"'"+search+"'"+" or phone="+"'"+search+"'";
