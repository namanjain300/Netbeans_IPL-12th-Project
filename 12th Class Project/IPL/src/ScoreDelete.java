...
public class ScoreDelete extends javax.swing.JFrame {
   ...
   String x,y;
public ScoreDelete(String p,String q)
    {
    x=p;
    y=q;
    initComponents();
    ...
    private void initComponents() {
        ...
        jButton5.setText("Worst Runs");
        jButton5.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton5ActionPerformed(evt);
            }
        });
        jPanel1.add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 150, 160, 30));
        ...
        jPanel1.add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 20, 160, 30));
        ...
        if(k==0)
   {
       Statement stmt=null;// Statement class is used to create the connectivity statement between java and mysql.
        try
        {
            ...
            String query;
            query="delete from score where srno="+"'"+search+"'";
 ...
 this.setVisible(false);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ScoreDelete().setVisible(true);
            }
        });
    }
